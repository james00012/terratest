...
require (
	...
	github.com/gruntwork-io/terratest/modules/shell/v2 v2.0.0-dryrun.1
...
require (
	...
	github.com/gruntwork-io/terratest/modules/http-helper/v2 v2.0.0-dryrun.1 // indirect
	github.com/gruntwork-io/terratest/modules/opa/v2 v2.0.0-dryrun.1 // indirect
